...
$error['FR'][PolymorphicArgumentException] = "Mod猫le inadmissible d'argument pour la fonction polymorphe.".
$error['DE'][PolymorphicArgumentException] = "Unzul盲ssiges Argumentmuster f眉r polymorphe Funktion.";
