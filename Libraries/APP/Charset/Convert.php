...
$str = "我"; // 字符编码就是本文件的字符编码
echo APP_Charset::is_charset($str, 'ascii') . '<br />';         //  0
echo APP_Charset::is_charset($str, 'gb2312') . '<br />';        //  1
echo APP_Charset::is_charset($str, 'gbk') . '<br />';           //  1
echo APP_Charset::is_charset($str, 'GB18030') . '<br />';       //  1
echo APP_Charset::is_charset($str, 'utf-8') . '<br />';         //  0
